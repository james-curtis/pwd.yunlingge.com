    ...
    <script>
        ...
        layui.use('table', function(){
          ...
          table.on('tool(pwd_list)', function(obj){
            ...
            <div class="layui-input-block">\
            <input type="text"  lay-verify="text" autocomplete="off" placeholder="用户名不改留空" class="layui-input"  name="user" id="user_info">\
            </div>\
            </div>\
            <div class="layui-form-item">\
            <label class="layui-form-label">密码</label>\
            <div class="layui-input-block">\
            <input type="text"  lay-verify="text" autocomplete="off" placeholder="密码不改留空" class="layui-input"  name="pass" id="pass_info">\
            </div>\
            </div>\
            <div class="layui-form-item">\
...
<script type="text/javascript">
    function inc_pwd(){
        ...
        <label class="layui-form-label">用户名</label>\
        <div class="layui-input-block">\
        <input type="text"  lay-verify="text" autocomplete="off" placeholder="用户名" class="layui-input"  name="user" id="user_info">\
        </div>\
        </div>\
        <div class="layui-form-item">\
        <label class="layui-form-label">密码</label>\
        <div class="layui-input-block">\
        <input type="text"  lay-verify="text" autocomplete="off" placeholder="密码" class="layui-input"  name="pass" id="pass_info">\
        </div>\
        </div>\
